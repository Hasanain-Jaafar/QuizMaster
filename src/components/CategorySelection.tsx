      ...
      {gameMode === 'create_room' && roomCode && (
        <div className="mb-6 p-4 md:p-5 bg-white rounded-xl border-2 border-primary/20 shadow-sm">
          ...
          <input
            ...
            className="w-full px-4 py-3 rounded-xl border-2 border-light-300 bg-white focus:border-primary focus:outline-none text-dark-300 placeholder:text-dark-100 mb-4 min-h-12"
            maxLength={32}
