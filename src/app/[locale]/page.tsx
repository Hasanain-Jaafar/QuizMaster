                      ...
                      {(['en', 'ar', 'sv'] as const).map((loc) => (
                        <Link
                          ...
                          className={`block px-3 py-2 text-sm transition-colors ${
                            locale === loc ? 'bg-primary/10 text-primary font-medium' : 'text-gray-700 hover:bg-gray-50'
                          }`}
                        >
                          {LANG_NAMES[loc]}
                        </Link>
                  ...
                  <div className="overflow-hidden">
                    <ul className="space-y-4 mt-4">
                      ...
                      <li className="flex items-start space-x-3">
                        ...
                        <span className="text-gray-600">{t('instruction5')}</span>
                      </li>
                    </ul>

                    <div className="mt-8 p-4 bg-linear-to-r from-blue-50 to-purple-50 rounded-xl">
                      <h4 className="font-semibold text-gray-900 mb-2">{t('quickTips')}</h4>
